...
// `:::checkpoint` line) gets an interactive Checkpoint rendered into it.
export default function LessonBody({ html, slug }) {
  ...
  useLayoutEffect(() => {
    if (!slug || !ref.current) { setSlots([]); return; } // eslint-disable-line react-hooks/set-state-in-effect
