...
export const DOMAINS = [
  ...
  },
  {
    ...
    lessons: [
      {
        slug: 'transportation-planning', title: 'Transportation planning', minutes: 30, access: 'free',
        description: 'MPOs and their plans, the four-step model, level of service versus VMT, induced demand, complete streets, Vision Zero, transit service, parking, access management, TOD, and TDM.',
      ...
      {
        slug: 'housing-and-community-development', title: 'Housing and community development', minutes: 29, access: 'paid',
        description: 'Affordability and cost burden, area median income, LIHTC and vouchers, CDBG, fair housing, fair share, missing middle and manufactured housing, rent regulation, and displacement.',
      ...
      {
        slug: 'environmental-planning-and-hazards', title: 'Environmental planning, hazards, and resilience', minutes: 31, access: 'paid',
        description: 'Environmental review, brownfields, the Endangered Species Act and water quality law, floodplains and the NFIP, hazard mitigation and disaster recovery, climate mitigation and adaptation, and green infrastructure.',
      ...
      {
        slug: 'economic-development', title: 'Economic development', minutes: 24, access: 'paid',
        description: 'Economic base theory and multipliers, location quotients in practice, clusters, retail analysis, economic impact analysis, incentives, and place-based tax programs.',
        outline: [],
        practice: ['e1:110', 'e1:116', 'e1:117', 'e2:101', 'e2:102', 'e3:138', 'e3:139', 'e3:140', 'e3:158', 'e3:159', 'e3:160', 'e3:161'],
      },
      {
        slug: 'urban-design-and-historic-preservation', title: 'Urban design and historic preservation', minutes: 29, access: 'paid',
        description: 'Principles of urban form, placemaking, CPTED, the transect, the National Register, Section 106, local historic districts, other preservation tools, and rehabilitation tax credits.',
      ...
      {
        slug: 'health-food-parks-and-regional-planning', title: 'Health, food systems, parks, and regional planning', minutes: 26, access: 'paid',
        description: 'Health impact assessment, food access, park classification and level of service, planning for all ages, smart-city data, and planning across jurisdictions.',
      ...
      {
        slug: 'rural-small-town-and-tribal-planning', title: 'Rural, small-town, and tribal planning', minutes: 22, access: 'paid',
        description: 'Planning with limited capacity, protecting farmland and rural character, directing rural growth, rural economies in transition, and working with tribal nations as sovereign governments.',
        outline: [],
        practice: ['e1:48', 'e3:71', 'e3:72', 'e3:73', 'e3:74', 'e3:164', 'e3:165'],
      },
      {
        slug: 'infrastructure-energy-and-water-planning', title: 'Infrastructure, energy, and water planning', minutes: 23, access: 'paid',
        description: 'How infrastructure steers growth, asset management, water supply and water rights, wastewater and stormwater, solid waste, energy siting, broadband, and fair siting.',
        outline: [],
