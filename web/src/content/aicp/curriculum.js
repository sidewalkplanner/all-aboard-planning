...
export const DOMAINS = [
  {
    ...
    lessons: [
      {
        slug: 'research-design-and-data', title: 'Research design and data sources', minutes: 22, access: 'free',
        description: 'Primary and secondary data, the Census and ACS, sampling, and how to judge whether evidence is valid and reliable.',
        outline: ['1.1 Conducting research and acquiring knowledge', '1.2 Data and source interpretation and evaluation', '1.5 Data collection strategies'],
      ...
      {
        slug: 'statistics-for-planners', title: 'Statistics and quantitative evaluation', minutes: 24, access: 'paid',
        description: 'Central tendency, spread, correlation, significance, margins of error, and discounting future costs and benefits.',
      ...
      {
        slug: 'demographic-and-economic-analysis', title: 'Population projections and economic analysis', minutes: 24, access: 'paid',
        description: 'Cohort-component and trend projections, dependency ratios, location quotients, shift-share, and measures of inequality.',
      ...
      {
        slug: 'spatial-analysis-and-gis', title: 'Spatial analysis and GIS', minutes: 18, access: 'paid',
        description: 'Vector and raster data, overlay and suitability analysis, choropleth maps, the modifiable areal unit problem, and gravity models.',
  ...
  },
  {
    ...
    lessons: [
      {
        slug: 'planning-history', title: 'A history of American planning', minutes: 26, access: 'free',
        description: 'From sanitary reform and the City Beautiful to the Garden City, the New Deal, urban renewal, New Urbanism, and Smart Growth.',
      ...
      {
        slug: 'planning-theory', title: 'Planning theory', minutes: 22, access: 'paid',
        description: 'Rational-comprehensive planning, incrementalism, mixed scanning, advocacy, equity, transactive and communicative planning, and the just city.',
      ...
      {
        slug: 'urban-form-and-settlement', title: 'Patterns of human settlement and urban form', minutes: 20, access: 'paid',
        description: 'Classic models of urban structure, central place theory, suburbanization, redlining and segregation, and how cities are perceived.',
      ...
      {
        slug: 'land-use-law-foundations', title: 'Foundations of land use law', minutes: 28, access: 'paid',
        description: 'The police power, enabling acts, Dillon’s Rule and home rule, due process, equal protection, the First Amendment, and the landmark zoning cases.',
      ...
      {
        slug: 'federal-policy-and-planning', title: 'Federal laws and programs that shaped planning', minutes: 22, access: 'paid',
        description: 'Housing acts, the Interstate highway program, NEPA, civil rights and fair housing law, and the federal grant programs planners still use.',
  ...
  },
  {
    ...
    lessons: [
      {
        slug: 'public-engagement-design', title: 'Designing public engagement', minutes: 22, access: 'free',
        description: 'Arnstein’s ladder, the IAP2 spectrum, choosing outreach techniques, and evaluating whether engagement actually worked.',
      ...
      {
        slug: 'equitable-and-accessible-engagement', title: 'Equitable, inclusive, and accessible engagement', minutes: 20, access: 'paid',
        description: 'Reaching people who are usually left out, language access, culturally appropriate communication, and accessible digital media.',
      ...
      {
        slug: 'consensus-and-negotiation', title: 'Facilitation, consensus building, and negotiation', minutes: 20, access: 'paid',
        description: 'Running fair meetings, active listening, structured group techniques, interest-based negotiation, mediation, and arbitration.',
      ...
      {
        slug: 'communicating-with-decision-makers', title: 'Staff reports, hearings, and the media', minutes: 22, access: 'paid',
        description: 'Writing staff reports, the roles of staff and officials, hearings and ex parte contacts, evidence-based arguments, and working with the press.',
  ...
  },
  {
    ...
    lessons: [
      {
        slug: 'zoning-fundamentals', title: 'Zoning fundamentals', minutes: 22, access: 'free',
        description: 'How a zoning ordinance is built: districts, the map and text, permitted and conditional uses, dimensional standards, and overlays.',
        outline: ['5.1 Develop and interpret rules and regulations'],
        practice: ['e1:31', 'e1:74', 'e1:75', 'e1:82', 'e2:75', 'e2:91'],
      },
      {
        slug: 'zoning-relief-and-nonconformities', title: 'Variances, rezonings, and nonconformities', minutes: 24, access: 'paid',
        description: 'Area and use variances, rezonings and spot zoning, contract zoning, quasi-judicial decisions, nonconforming uses, amortization, and moratoria.',
        outline: ['5.1 Develop and interpret rules and regulations'],
        practice: ['e1:47', 'e1:76', 'e1:77', 'e1:78', 'e2:74', 'e2:76', 'e2:77', 'e2:88', 'e2:89', 'e2:93', 'e3:85', 'e3:86', 'e3:87', 'e3:88', 'e3:89', 'e3:128'],
      },
      {
        slug: 'subdivision-and-development-review', title: 'Subdivision and development review', minutes: 20, access: 'paid',
        description: 'Plats, improvement guarantees, site plan review, consistency findings, vested rights, development agreements, and the official map.',
      ...
      {
        slug: 'capital-planning-and-finance', title: 'Capital planning and public finance', minutes: 24, access: 'paid',
        description: 'The capital improvements program, bonds, tax increment financing, special assessments, impact fees, and business improvement districts.',
      ...
      {
        slug: 'monitoring-and-implementation-programs', title: 'Implementation programs, partnerships, and monitoring', minutes: 18, access: 'paid',
        description: 'Action plans with owners and timelines, strategic partnerships, removing obstacles, indicators, and keeping a plan current.',
