...
export const STUDY_PLANS = [
  {
    ...
    weeks: [
      ...
      { focus: 'Planning law and ethics', lessons: ['takings-and-exactions', 'federal-policy-and-planning', 'aicp-code-of-ethics', 'conflicts-of-interest-and-rules-of-conduct', 'solving-ethics-questions'], practice: [quizB, drill('Code of Ethics & Professional Conduct', 'Ethics'), cards('10 minutes a day on this week\'s topics')] },
      { focus: 'Making plans', lessons: ['the-planning-process', 'comprehensive-plans', 'goals-objectives-policies', 'plan-analysis-tools'], practice: [drill('Plan & Policy Development', 'Plan & Policy'), cards('10 minutes a day on this week\'s topics')] },
      { focus: 'Zoning and development regulation', lessons: ['zoning-fundamentals', 'zoning-relief-and-nonconformities', 'subdivision-and-development-review', 'growth-management-and-innovative-tools', 'implementation-math'], practice: [drill('Plan Implementation', 'Implementation'), cards('10 minutes a day on this week\'s topics')] },
  ...
  },
  {
    ...
    weeks: [
      ...
      { focus: 'The AICP Code of Ethics', lessons: ['aicp-code-of-ethics', 'conflicts-of-interest-and-rules-of-conduct', 'solving-ethics-questions'], practice: [drill('Code of Ethics & Professional Conduct', 'Ethics'), drill('Fundamental Planning Knowledge', 'Fundamentals'), cards('10 minutes a day on this week\'s topics')] },
      { focus: 'Making plans', lessons: ['the-planning-process', 'comprehensive-plans', 'goals-objectives-policies', 'plan-analysis-tools'], practice: [drill('Plan & Policy Development', 'Plan & Policy'), cards('10 minutes a day on this week\'s topics')] },
      ...
      { focus: 'Growth management, math, and finance', lessons: ['growth-management-and-innovative-tools', 'implementation-math', 'capital-planning-and-finance', 'monitoring-and-implementation-programs'], practice: [drill('Plan Implementation', 'Implementation'), cards('10 minutes a day on this week\'s topics')] },
      { focus: 'Research and assessment methods', lessons: ['research-design-and-data', 'statistics-for-planners', 'demographic-and-economic-analysis', 'spatial-analysis-and-gis'], practice: [drill('Research & Assessment Methods', 'Research'), exam('e1', 1, 'practice'), cards('10 minutes a day on this week\'s topics')] },
      { focus: 'Communication and interaction', lessons: ['public-engagement-design', 'equitable-and-accessible-engagement', 'consensus-and-negotiation', 'communicating-with-decision-makers'], practice: [drill('Communication & Interaction', 'Communication'), cards('10 minutes a day on this week\'s topics')] },
      { focus: 'Administration and leadership', lessons: ['project-and-contract-management', 'managing-a-planning-agency', 'leadership-in-planning', 'mentoring-and-professional-development'], practice: [drill('Administration & Management', 'Administration'), drill('Leadership', 'Leadership'), cards('10 minutes a day on this week\'s topics')] },
