...
// Practice Exam 1 in practice mode is the baseline: its results rank the domains to study first.
const baseline = { label: 'Practice Exam 1 in practice mode: your baseline (untimed, saves as you go)', to: P.runExam('e1', 'practice') };
...
const focus = { label: 'Reread the lessons for the top domain on your dashboard\'s "Study these first" list', to: P.progress };
...
export const STUDY_PLANS = [
  {
    ...
    weeks: [
      { focus: 'Baseline and planning history', lessons: ['planning-history', 'planning-theory', 'urban-form-and-settlement', 'land-use-law-foundations'], practice: [strategy, baseline] },
      ...
      { focus: 'Finance, monitoring, and research methods', lessons: ['capital-planning-and-finance', 'monitoring-and-implementation-programs', 'research-design-and-data', 'statistics-for-planners', 'demographic-and-economic-analysis', 'spatial-analysis-and-gis'], practice: [focus, cards('10 minutes a day on this week\'s topics')] },
  ...
  },
  {
    ...
    weeks: [
      ...
      { focus: 'Research and assessment methods', lessons: ['research-design-and-data', 'statistics-for-planners', 'demographic-and-economic-analysis', 'spatial-analysis-and-gis'], practice: [revisit('research', 'Research'), focus, cards('10 minutes a day on this week\'s topics')] },
      ...
      { focus: 'Final review', lessons: [], practice: [exam('e3', 3, 'timed'), quickRef, review, cards('your weakest cards, every day this week')] },
    ],
  },
];
