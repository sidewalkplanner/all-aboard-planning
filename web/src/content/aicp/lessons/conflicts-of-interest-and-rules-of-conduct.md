...
### The standard response: disclose and step back

When a planner has a personal or financial interest in a matter:

1. **Disclose** the interest, typically **in writing** and to the appropriate parties (a supervisor, the decision-making body, and on the public record where relevant).
2. **Withdraw (recuse)** from participating in the matter: no analysis, recommendation, or influence on colleagues.

**Disclosure alone isn't enough** when the planner has a real financial interest in a matter under review. The planner must both disclose and refrain from participating.

For **prior professional relationships**, such as a consultant who worked for an applicant years earlier in another state, the usual appropriate step is to **disclose the relationship on the record** so decision-makers and the public can judge it. Depending on how close and how recent the relationship is, withdrawal may also be required. When a planner changes jobs, from a consulting firm to a city for example, and is assigned a file their former firm is working on, the planner should disclose the prior relationship and follow the agency's recusal procedures.
...
When a planner **advocates a client's position at a public hearing** or elsewhere in public, the planner must **identify the interest being represented** (the client) and must **not misrepresent facts**. Public officials and residents are entitled to know whose case they're hearing.

### Protecting the process

The Rules also protect the integrity of the ethics system:

- Don't file a **charge of misconduct you know to be frivolous** or without basis.
- Don't **retaliate** against someone who files a charge in good faith or cooperates with an investigation.
...
**The nonprofit board.** A city planner volunteers on the board of a nonprofit housing developer. The nonprofit applies for a rezoning in the city. The planner discloses the board role in writing to the planning director and withdraws from reviewing the application, and the director assigns the case to another planner.

**The spouse's job offer.** While reviewing a large project, a planner learns that the applicant has offered the planner's spouse a well-paid position. This is a financial conflict. The planner must disclose it and withdraw from the review. Signing the staff recommendation without disclosing it would violate the conflict rules.
