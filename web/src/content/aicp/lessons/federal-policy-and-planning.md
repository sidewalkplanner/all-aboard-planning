...
- Describe the major federal housing laws from 1934 to 1974 and what each changed.
- Explain the purpose and effects of the Federal-Aid Highway Act of 1956 and later surface transportation laws.
- Summarize NEPA and the major environmental statutes planners encounter.
- Identify the civil rights, fair housing, and accessibility laws that shape planning practice.
- Recognize the federal grant programs planners still use and match each to its purpose.

## Key concepts

Land use regulation is mostly a state and local power, but federal money and federal law have shaped American communities as much as any zoning code. The exam expects you to connect each major law to its core purpose.

### Housing and community development

| Law or program | What it did |
|---|---|
| **National Housing Act of 1934** | Created the **Federal Housing Administration (FHA)**, which insured long-term, low-down-payment mortgages. It transformed home buying, and its underwriting standards favored new suburban, racially segregated development. |
| **Housing Act of 1937** | Created the federal **public housing** program, run through local housing authorities. |
| **Housing Act of 1949** | Declared the goal of "a decent home and a suitable living environment for every American family" and launched **urban renewal** (Title I), which funded land clearance and redevelopment. |
...
- The **National Environmental Policy Act (NEPA)**, signed January 1, 1970, requires federal agencies to consider the environmental effects of their actions. For **major federal actions significantly affecting the quality of the human environment**, the agency must prepare an **Environmental Impact Statement (EIS)**. NEPA is procedural: it requires agencies to study and disclose impacts, not to choose the least harmful option. Many states have their own "little NEPA" laws that reach state and local actions. See [Environmental planning, hazards, and resilience](/aicp/lessons/environmental-planning-and-hazards).
- The **Clean Air Act** (major amendments 1970 and 1990) sets national air quality standards. Regions that fail them are designated **nonattainment** areas, and their transportation plans must show **conformity** with the state's air quality plan.
...
- **FHA**: The Federal Housing Administration, created in 1934 to insure mortgages.
- **Urban renewal**: The federal land clearance and redevelopment program launched by the Housing Act of 1949.
- **Section 701**: The 1954 program of federal grants for local and regional planning.
- **CDBG**: The Community Development Block Grant, a flexible federal grant created in 1974 for housing, facilities, and economic development that primarily benefits low- and moderate-income people.
- **Highway Trust Fund**: The fuel-tax fund created in 1956 to finance the Interstate system.
- **3C process**: The continuing, comprehensive, and cooperative metropolitan transportation planning process.
- **NEPA**: The National Environmental Policy Act, which requires environmental review of major federal actions.
- **Environmental Impact Statement (EIS)**: A detailed NEPA analysis for major federal actions with significant effects.
- **Nonattainment area**: A region that fails a national ambient air quality standard.
